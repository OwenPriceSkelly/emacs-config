...
#+BEGIN_SRC emacs-lisp :lexical yes
(let* ((+override-theme 'doom-solarized-dark-high-contrast)
       ;(+override-theme nil)
...
(after! vertico
  ...
  ;; (setq +vertico-company-completion-styles '(flex basic partial-completion orderless))
  )
#+END_SRC
** Programming
*** LSP
...
is). Genuinely unsure why the best completion I've tried is the out-of-box
...
#+END_SRC
*** C#
Not currently using C#, hopefully not going to need to tbh
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
***** COMMENT package: org-roam-server
#+BEGIN_SRC emacs-lisp :lexical yes
